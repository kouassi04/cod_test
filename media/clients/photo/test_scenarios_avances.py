...
class AdvancedSecurityTests(TestCase):
    ...
    def test_signup_invalid_email_formats(self):
        """TC-ADV-01: Bombardement avec 5 formats d'emails invalides"""
        bad_emails = [
            'pas-arobase.com', 
            'double@@gmail.com', 
            '@domaine-seul.com', 
    ...
    def test_cart_negative_quantity(self):
        ...
        etab = Etablissement.objects.create(user=self.user, nom="E", categorie=cat, nom_du_responsable="X", prenoms_duresponsable="Y", contact_1="00")
        ...
        # Vérification : Le panier doit rester vide ou ignorer ces ajouts
        # Note : Si ton code actuel permet ça, ce test va échouer et te montrer un vrai bug à corriger !
        # Pour l'instant, on vérifie juste que ça ne crashe pas (Code 200)
