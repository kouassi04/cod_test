...
class CustomerAuthTests(TestCase):
    """Module 3: Tests Authentification & Inscription (20 Tests)"""
...
class CustomerCartTests(TestCase):
    ...
    def setUp(self):
        ...
        etab = Etablissement.objects.create(user=self.user, nom="Etab", categorie=cat, nom_du_responsable="X", prenoms_duresponsable="Y", contact_1="00")
